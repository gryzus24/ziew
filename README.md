...
### Prebuilt binary
You can [download the prebuilt binary](https://github.com/gryzus24/ziew/releases/download/v0.0.11/ziew) from the Releases page. If you do not trust it you can always build directly from source.
